...
entity divisor_datos is
	port(
		...
		prueba : out std_logic_vector(1 downto 0);	-- Necesitamos 2 bits para representar A, B, C y D + 1 bit para Qaux
		ligaF : out std_logic_vector(2 downto 0);		-- Tenemos 7 estados, necesitamos 3 bits para representarlos
		ligaV : out std_logic_vector(2 downto 0);		-- Tenemos 7 estados, necesitamos 3 bits para representarlos
